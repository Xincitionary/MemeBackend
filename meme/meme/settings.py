...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': True,   #If user has been using it during the 60 days, the refresh token gets updated so that it does not expire after 60 days 
